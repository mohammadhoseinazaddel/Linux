...
### instaling oh my zsh
  ...
  added plugins [installed plugins](/installation/zshrc)
...
```
```
sudo docker run --name postgresql -e POSTGRES_DB=airlines -e POSTGRES_USER=mhazad -e POSTGRES_PASSWORD=123456 -p 5432:5432 -v data:/var/lib/postgresql/data -d postgres
```
```
docker ps -a
```
